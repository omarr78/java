...
public class Main {
    public static void main(String[] args) {
        ...
        Comparator<String> comp = new Comparator<String>() {
            @Override
            public int compare(String a, String b) { // increasing order
                if (a.length() > b.length()) return 1;
                // 1 (or any positive number): a should come after b -> b , a "swap"

                else if (a.length() < b.length()) return -1;
                // -1 (or any negative number): (a) should come before (b) --> a , b "no swap"
                
                else return 0;
                // 0 : (a) and (b) are equal in ordering "no swap" 
            }
        };
